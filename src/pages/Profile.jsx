  ...
  return (
    ...
    <div className="w-full max-w-5xl p-6 mx-auto space-y-6">
        ...
        <div>
          ...
          <div className="flex flex-col w-full pt-4 mt-4 text-sm text-gray-700 md:mt-0 md:ml-auto">
            ...
            <div className="flex justify-between py-1 border-b">
              ...
              <span>{user?.currentWeight != null ? `${user.currentWeight} kg`  : 'N/A'}</span>
            </div>
            <div className="flex justify-between py-1">
              <span className="w-32 font-semibold">Target Weight</span>
              <span>{user?.targetWeight != null ? `${user.targetWeight} kg` : 'N/A'}</span>
            </div>
            ...
            <div className="flex justify-end mt-4">
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-white bg-gray-800 rounded-lg hover:bg-gray-600"
              >
                Edit
              </button>
            </div>
      ...
      {showModal && (
        ...
        >
          <div className="relative w-full max-w-2xl p-6 bg-white border rounded-lg shadow-md backdrop-blur-md border-gray-500/30"
          ...
          >
            ...
            <form onSubmit={handleSubmit} className="mt-4 space-y-4">
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  className="px-4 py-2 text-white bg-gray-800 rounded-lg hover:bg-gray-600"
                >
                  Edit Details
                </button>
              </div>
